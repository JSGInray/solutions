...
- File paths, counted from the repository root (for example `My Solution/config/versioned/...`), must not exceed **170 characters**; the product installs Solutions below a deep Windows folder, and longer paths cannot be installed. A CI check enforces this limit
